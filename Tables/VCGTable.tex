...
\caption[Vegetative Compatibility Groups of \Focub]{{\textbf{Vegetative Compatibility Groups of \Focub} and race (Czislowski \et 2018).} Cross-compatible VCGs can form VCG complexes.}
\label{tab:VCGTab}\\
\hline
